...
RSpec.describe Requirements::Checkers::TopicChecker do
  ...
  describe "#pre_publish_issues" do
    ...
    it "returns no issues if there are none" do
      ...
      issues = Requirements::Checkers::TopicChecker.new(edition).pre_publish_issues
    ...
    context "when the Publishing API is down" do
      ...
      it "raises an exception if we specify it should" do
        expect { Requirements::Checkers::TopicChecker.new(edition).pre_publish_issues(rescue_api_errors: false) }

...
RSpec.describe "documents/show.html.erb" do
  ...
  describe "document summary" do
    it "shows the document and edition metadata" do
      ...
      expect(rendered)
        .to have_tag(".app-c-metadata",
                     seen: /#{I18n.t!("documents.show.metadata.created_at")} User 2/)
      expect(rendered)
        .to have_tag(".app-c-metadata",
                     seen: /#{I18n.t!("documents.show.metadata.last_edited_by")} User 1/)
    end
  end
  ...
  describe "tags" do
    ...
    it "shows the topics when a document has tags" do
      ...
      expect(render).to have_tag("#tags") do
        with_text(/Tag name/)
      end
    end
  ...
  describe "topics" do
    ...
    it "shows the topics when a document has topics" do
      ...
      expect(render).to have_tag("#topics") do
        with_text(/Level One Topic/)
        with_text(/Level Two Topic/)
        with_text(/Level Three Topic/)
      end
    end

module WhitehallImporter
  ...
  private
    ...
    def primary_publishing_organisation_matches?
      proposed_link = proposed_payload.dig(:links, :primary_publishing_organisation).presence
      proposed_link == publishing_api_link(:primary_publishing_organisation).presence
    end

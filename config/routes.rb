...
Rails.application.routes.draw do
  ...
  get "/documents/new" => "new_document#choose_document_type", as: :choose_document_type
  post "/documents/choose-document-type" => "new_document#choose_or_create_document_type", as: :choose_or_create_document_type
